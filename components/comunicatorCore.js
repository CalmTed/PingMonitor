...
var comunicatorCore = /** @class */ (function () {
    function comunicatorCore() {
        var _this = this;
        ...
        this.subscribe = function (_a) {
            var channel = _a.channel, commandListString = _a.commandListString, callback = _a.callback;
            _this.__subscriptions.push({
                channel: channel,
